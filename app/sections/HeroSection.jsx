...
function HeroSection() {
  return (
    <section className="min-h-screen flex items-start justify-start bg-gradient-to-br from-teal-50 via-white to-gray-100 backdrop-blur-3xl px-4 sm:px-8 pt-24 sm:pt-28">
      <div className="bg-white/60 backdrop-blur-2xl rounded-2xl p-6 sm:p-8 md:p-10 text-center shadow-md border border-gray-200 max-w-2xl w-full">
        ...
        <div className="flex justify-center gap-2 mt-8">
          <button className="bg-teal-600 text-white border border-teal-600 px-7 sm:px-9 py-2.5 sm:py-3 rounded-l-full font-semibold tracking-tight shadow-sm hover:bg-teal-700 hover:shadow-md transition-all duration-300">
            FE
          </button>
          <button className="border border-teal-600 text-teal-600 px-7 sm:px-9 py-2.5 sm:py-3 rounded-r-full font-semibold tracking-tight hover:bg-teal-50 hover:shadow-sm transition-all duration-300">
            BE
          </button>
        </div>
