...
function HeroSection() {
  return (
    <section className="min-h-screen flex items-center justify-start bg-gradient-to-br from-teal-50 via-white to-gray-100 backdrop-blur-3xl px-4 sm:px-8 pt-24 sm:pt-28">
